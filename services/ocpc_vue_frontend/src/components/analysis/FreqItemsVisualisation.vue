<template>
    <div class="wrap">
        <h3 class="card-4">Frequent Itemsets</h3>
...
export default {
    ...
    methods: {
        ...
        onChangeSetSize(event){
            ...
            console.log("Slected Min Supp: " + selectedValue)
            let props = {}
            ...
            console.log("Freq_Items_vis: ")
            console.log(props)
            this.$emit('fitems_props_changed', props)
        },
        onChangeSupp(event){
            let selectedValue = event.target.value
            console.log("Slected Min Supp: " + selectedValue)
    ...
    emits: ['select-analysis', 'edit-freq-attrs', 'fitems_props_changed']
}
</script>
